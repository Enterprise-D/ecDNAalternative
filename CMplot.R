...
count_freq_file = "data/assessment/LC675_count_freq.txt"
...
CMplot(b, plot.type = "m", col = c("grey30", "grey60"), LOG10 = FALSE, ylim = c(0, 1), threshold = c(0.05, 0.1),
       ...
       main = "LC675_linear_model", ylab = 'Proportion', axis.cex = 0.7,
       file = "jpg", file.name = "LC675_linear_model", dpi = 300, file.output = TRUE, verbose = TRUE, width = 14, height = 6)
