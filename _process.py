...
# %%
res['eta'] = linear_model['Estimate'].iloc[0] + linear_model['Estimate'].iloc[1] * input['cnv'] + linear_model['Estimate'].iloc[2] * \
             input['ratio'] + linear_model['Estimate'].iloc[3] * input['gini']
